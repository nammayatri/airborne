...
export declare function markBundleSafe(nameSpace: string): Promise<void>;
export declare function startBackgroundDownload(nameSpace: string, jobId?: string): Promise<boolean>;
export declare function hasPendingBundleUpdate(nameSpace: string): Promise<boolean>;
export declare function applyPendingBundleUpdate(nameSpace: string): Promise<boolean>;
